          ...
          <form className="space-y-2" onSubmit={submitHandler}>
            ...
            <label className="text-gray-900 leading-6 text-sm font-medium">
              ...
              <input
                ...
                id="emailid"
                name="emailid"
                placeholder="krpiyu9798@gmail.com"
                className="w-full border mt-2 rounded-md  p-2 text-gray-900 shadow-sm ring-1 placeholder:text-gray-400 placeholder:font-normal"
              />
            </label>
            <br />
            ...
            ">
              <legend className="text-sm font-semibold leading-6 text-gray-900">Checkboxes...!!!</legend>
              <br />
            ...
            <fieldset className="mt-10">
              <legend className="text-sm font-semibold leading-6 text-gray-900">Radio_buttons...!!   Push Notification</legend>
